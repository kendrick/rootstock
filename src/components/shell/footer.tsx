		...
		<footer className="border-t-2 border-rule bg-background">
			<div className="mx-auto w-full max-w-7xl px-6 py-4">
				...
				<div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-2">
					<p className="font-mono text-detail text-muted print:text-black">{OPEN_METEO_ATTRIBUTION}</p>
					...
					<Link
						href="/about"
						className="font-display text-label font-bold tracking-widest text-muted uppercase underline underline-offset-4 print:hidden"
					>
						How this works
					</Link>
				</div>
