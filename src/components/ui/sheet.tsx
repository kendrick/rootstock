...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-plate-ink/70 dark:bg-plate-paper/15 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 pr-20 text-left",
      className
    )}
    {...props}
  />
